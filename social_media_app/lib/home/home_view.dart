...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('My Social App')),
  ...
  Widget _postView(BuildContext context) {
    return Column(
        ...
        children: [_postAuthorRow(context), _postImage(), _postCaption(), _postCommentsButton(context)]);
  }
  ...
  Widget _postCaption() {
    return Padding(
      ...
      child: Text('Welcome to Viskum tech...'),
    );
  }
  ...
  Widget _postCommentsButton(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          context.read<HomeNavigatorCubit>().showComments();
        },
        child: Text(
          'View Comments',
